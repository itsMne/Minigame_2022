...
// マクロ定義
//*****************************************************************************
#define DEBUG_VISIBILITY false//見えないオブジェクトを表すことを管理する

//*****************************************************************************
// グロバル変数
//*****************************************************************************
SceneInGame* pCurrentGame = nullptr;//メインゲームのグロバルポインター

//*****************************************************************************
// コンストラクタ関数
//*****************************************************************************
SceneInGame::SceneInGame(int nLevel)
{
	pCurrentGame = this;
	pBackground = nullptr;
	pBackgroundEvent = nullptr;
...
void SceneInGame::Init()
{
	...
	{
	case DEBUG_ROOM://レベルエディター
		SetVolume(1);
		if (!pBackground)
			pBackground = new GameObject();
		pBackground->Init(GetTexture(TEXTURE_BACKGROUND1), BACKGROUND_OBJECT_TYPE);
		pBackground->SetUIObject(true);
		pBackground->SetAlpha(0.30f);
		pBackground->SetSpriteSize(WINDOW_WIDTH, WINDOW_HEIGHT);
		PlaySound(SOUND_LABEL_BGM_DEBUGROOM);
		ColorBackground = { 0.525f, 0.55f, 0.85f, 1 };
		DebugRoomObjects();
		SetLevelScale(0.75f);
		break;
	case TUTORIAL_ROOM://チュートリアルレベル
		if (!pBackground)
			pBackground = new GameObject();
		pBackground->Init(GetTexture(TEXTURE_BACKGROUND3), BACKGROUND_OBJECT_TYPE);
		pBackground->SetUIObject(true);
		pBackground->SetAlpha(1);
		pBackground->SetSpriteSize(WINDOW_WIDTH, WINDOW_HEIGHT);
		if (!pBackgroundEvent)
			pBackgroundEvent = new GameObject();
		pBackgroundEvent->Init(GetTexture(TEXTURE_BACKGROUNDEVENT), BACKGROUND_EVENT_TYPE);
		pBackgroundEvent->SetSpriteSize(0, 0);
		pBackgroundEvent->SetAlpha(0.5f);
		pBackgroundEvent->SetUIObject(true);
		SetVolume(1);
		...
		SetLevelScale(0.90f);
		break;
	case LEVEL1_ROOM://メインゲームのレベル
		if (!pBackground)
			pBackground = new GameObject();		
		pBackground->Init(GetTexture(TEXTURE_BACKGROUND2), BACKGROUND_OBJECT_TYPE);
		pBackground->SetUIObject(true);
		pBackground->SetAlpha(1);
		pBackground->SetSpriteSize(WINDOW_WIDTH, WINDOW_HEIGHT);
		if (!pBackgroundEvent)
		...
		//
		ColorBackground = { 190/255.0f, 198/255.0f , 245.0f/255.0f, 1 };
...
{
	if (nCurrentLevel == LEVEL1_ROOM) {
		if (pBackgroundEvent)
			pBackgroundEvent->Draw();
		if (pBackground)
			pBackground->Draw();
	}
	else
...
void SceneInGame::End()
{
		...
		SAFE_DELETE(pBackgroundEvent);

#ifdef USE_CONSOLE
		printf("ENDING PICKABLES\n");
#endif // USE_CONSOLE
		SAFE_DELETE(PickableGems);
...
//戻：void
//*****************************************************************************
void SceneInGame::TutorialObjects()
{
	SetBackgroundColor(ColorBackground);
	PickableGems->Load("GameLevels/Tutorial_Gems_Level", GEM_TYPE);
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,3461.000f,false,nullptr }, 150, { -1343.000f, 1316.000f }, { 150.000f,3461.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,306.000f,false,nullptr },  150, { 1342.000f, -219.000f }, { 150.000f,306.000f });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,162.000f,false,nullptr }, 150, { 2158.000f, 37.000f }, { 150.000f,162.000f });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,157.000f,false,nullptr }, 150, { 3297.000f, 343.000f }, { 150.000f,157.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,392.000f,false,nullptr }, 150, { 2305.000f, 107.000f }, { 150.000f,392.000f });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2505.000f,false,nullptr }, 150, { 3295.000f, 1562.000f }, { 150.000f,2505.000f });
	...
	GameObject* WallLeft = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,3286.000f,false,nullptr },  150, { 1507.000f, 4460.000f }, { 150.000f,3286.000f });
	GameObject* WallRight = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,3286.000f,false,nullptr }, 150, { 4812.000f, 4460.000f }, { 150.000f,3286.000f });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2262.000f,false,nullptr }, 150, { 3791.187f, 1694.082f }, { 150.000f,2262.000f });
	...
	WallLeft = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,5235.000f,false,nullptr }, 150, { 7952.189f, 5342.870f }, { 150.000f,5235.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,5235.000f,false,nullptr }, 150, { 12272.189f, 5342.870f }, { 150.000f,5235.000f });
	//BOUNCINGチュートリアル
	WallRight = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,748.000f,false,nullptr }, 150, { 9961.084f, 3278.543f }, { 150.000f,748.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,142.000f,false,nullptr }, 150, { 9962.884f, 2837.870f }, { 150.000f,142.000f });
	...
	WallLeft = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2395.000f,false,nullptr }, 150, { 9475.189f, 4814.258f }, { 150.000f,2395.000f });
	WallRight = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,770.000f,false,nullptr }, 150, { 11372.189f, 4134.258f }, { 150.000f,770.000f });
	LastEnemyAdded = Enemies->AddEnemy(BUNBUN_ENEMY, { 10972.189f,3859.258f }, ENEMY_TUTORIAL2_DOUBLEJUMPEN2);
	LastEnemyAdded->SetWallLimits(WallRight, WallLeft);
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,142.000f,false,nullptr },  150, { 11372.884f, 3702.870f }, { 150.000f,142.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,1948.000f,false,nullptr }, 150, { 10878.383f, 5445.019f }, { 150.000f,1948.000f });
	...
	//スイッチチュートリアル
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,4953.000f,false,nullptr }, 150, { 7440.000f, 10381.000f }, { 150.000f,4953.000f });
	WallRight = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,4953.000f,false,nullptr }, 150, { 12715.000f, 10381.000f }, { 150.000f,4953.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,4941.000f,false,nullptr }, 150, { 8470.000f, 10377.000f }, { 150.000f,4941.000f });
	...
	WallLeft = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,4935.000f,false,nullptr }, 150, { 8982.000f, 10790.000f }, { 150.000f,4935.000f });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,446.000f,false,nullptr }, 150, { 9706.000f, 8141.225f }, { 150.000f,446.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,162.000f,false,nullptr }, 150, { 9558.000f, 8042.000f }, { 150.000f,162.000f });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,448.000f,false,nullptr }, 150, { 10279.000f, 8562.000f }, { 150.000f,448.000f });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,168.000f,false,nullptr }, 150, { 10129.000f, 8457.000f }, { 150.000f,168.000f });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,154.000f,false,nullptr }, 150, { 10688.000f, 8878.000f }, { 150.000f,154.000f });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,458.000f,false,nullptr }, 150, { 10837.000f, 9003.000f }, { 150.000f,458.000f });
...
//戻：void
//*****************************************************************************
void SceneInGame::Level1_1Objects()
{
	SetBackgroundColor(ColorBackground);
	Floor* LastFloorAdded;
	GameObject* LastGOAdded = nullptr;
	SwitchGO* LastSwitchAdded = nullptr;
	...
	PickableGems->Load("GameLevels/1_1_Gems_Level", GEM_TYPE);
	...
	LastSwitchAdded = (SwitchGO*)LevelObjects->AddSwitchBulb({ 7780.0f, 2920.5f }, SWITCH_L1_No7, false);
	LastSwitchAdded->SetSwitchResistance(4);
	...
	//秘密
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,3135.000f,false,nullptr }, 150, { -6050.000f, -2214.000f }, { 150.000f,3135.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,3135.000f,false,nullptr }, 150, { -5525.000f, -2214.000f }, { 150.000f,3135.000f });
	...
	//動ける床の行事
	LastFloorAdded = (Floor*)Floors->AddFloor(REGULAR_FLOOR_RED_TEXTURE, { 0,-80,WINDOW_WIDTH*0.6f,50,false,nullptr }, 270, { 13785.00f + 2000, 7115.58f }, { WINDOW_WIDTH*0.6f, 270 }, STATIC_ID, { 13785.00f,7115.58f }, { 17886.95f,7115.58f }, { 5 ,5 }, { 13074.95f, 7150.66f });
	...
	BlockWithSpikes = Walls->AddWall(EVIL_BLOCK2_TEXTURE, { 0,0, 150,150 * 1 }, 150, { 15234.95f, 7115.61f }, { 150, 150 * 1 }, STATIC_ID, WALL_NORMAL, { 15234.95f, 7115.61f }, { 15234.95f, 7915.61f }, { 0, 10 }, 0);
	BlockWithSpikes->SetUpMoveControl({ 15234.95f, 7115.61f }, { 15234.95f, 7915.61f }, { 0, 10 });
	printf("THIS WALL: %d IS %d\n", ((Wall*)BlockWithSpikes)->GetWallID(), ((Wall*)BlockWithSpikes)->GetTypeScaleActivation());
	...
	//動ける床2の行事
	LastFloorAdded = (Floor*)Floors->AddFloor(REGULAR_FLOOR_RED_TEXTURE, { 0,-80,WINDOW_WIDTH*0.6f,50,false,nullptr }, 270, { 21775.95f, 7115.58f }, { WINDOW_WIDTH*0.6f, 270 });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2533.000f,false,nullptr }, 150, { 6640.000f, -2659.000f }, { 150.000f,2533.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2533.000f,false,nullptr }, 150, { 8000.000f, -2654.000f }, { 150.000f,2533.000f });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,4528.000f,false,nullptr }, 150, { 26430.000f, 9112.500f }, { 150.000f,4528.000f });
	//秘密2
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2570.000f,false,nullptr }, 150, { 10968.000f, -2182.119f }, { 150.000f,2570.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2570.000f,false,nullptr }, 150, { 13713.000f, -2182.119f }, { 150.000f,2570.000f });
	...
	LastGOAdded = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,-80,150,9271.000f,false,nullptr }, 150, { 26457.000f, 3007.500f }, { 150.000f,9271.000f }, WALL_1_FALLING1);
	LastGOAdded->SetVisibility(DEBUG_VISIBILITY);
	LastGOAdded->SetUse(false);
	LastGOAdded = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,-80,150,9271.000f,false,nullptr }, 150, { 23902.000f, 3007.500f }, { 150.000f,9271.000f }, WALL_1_FALLING2);
	LastGOAdded->SetVisibility(DEBUG_VISIBILITY);
	LastGOAdded->SetUse(false);
...
//戻：void
//*****************************************************************************
void SceneInGame::Level1_2Objects()
{
	GameObject* LastGOAdded = nullptr;
	SwitchGO* LastSwitchAdded = nullptr;
	...
	if (pUIManager) {
		UI_Object* pAtkZoom = pUIManager->GetAttackZoom();
		if (pAtkZoom)
			pAtkZoom->SetTexture(GetTexture(TEXTURE_UI_ATK_EFFECT_ALT));
	}
	LevelObjects->AddSpike({ -1680.000f,-4004.954f }, 784);
	PickableGems->Load("GameLevels/1_2_Gems_Level", GEM_TYPE);
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,2696.000f,75,false,nullptr }, 270, { 0, 0 }, { 2696.000f,270.000f }, FLOOR_LV1_REGULAR_C);
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,8033.000f,75,false,nullptr }, 270, { 25032.000f, -902.500f }, { 8033.000f,270.000f }, FLOOR_LV1_REGULAR_B);
	LastGOAdded = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,-80,150,9271.000f,false,nullptr }, 150, { 26457.000f, 3007.500f }, { 150.000f,9271.000f }, WALL_1_FALLING1);
	LastGOAdded->SetVisibility(DEBUG_VISIBILITY);
	LastGOAdded = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,-80,150,9271.000f,false,nullptr }, 150, { 23902.000f, 3007.500f }, { 150.000f,9271.000f }, WALL_1_FALLING2);
	LastGOAdded->SetVisibility(DEBUG_VISIBILITY);
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,308.000f,false,nullptr }, 150, { -1408.000f, 38.000f }, { 150.000f,308.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,308.000f,false,nullptr }, 150, { 1417.000f, 38.000f }, { 150.000f,308.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1064.000f,75,false,nullptr }, 270, { 1871.000f, 298.000f }, { 1064.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1064.000f,75,false,nullptr }, 270, { -1864.000f, 303.000f }, { 1064.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_YELLOW_TEXTURE, { 0,-80,0,75,false,nullptr }, 270, { -4341.000f, 536.000f }, { 0,270.000f }, FLOOR_LV1_EXPANDABLE6);
	LevelObjects->AddSwitchBulb({ -2326.00f, 636.00f }, SWITCH_L1_No9, true);
	Floors->AddFloor(DOMINOS_FLOOR_YELLOW_TEXTURE, { 0,-80,0,75,false,nullptr }, 270, { -6901.000f, 921.000f }, { 0,270.000f }, FLOOR_LV1_EXPANDABLE7);
	...
	Floors->AddFloor(DOMINOS_FLOOR_YELLOW_TEXTURE, { 0,-80,5255.000f,75,false,nullptr }, 270, { -9649.000f, 1249.513f }, { 5255.000f,270.000f }, FLOOR_LV1_EXPANDABLE8);

	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1944.000f,75,false,nullptr }, 270, { 0.000f, 4532.000f }, { 1944.000f,270.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2418.000f,false,nullptr }, 150, { -955.000f, 5597.000f }, { 150.000f,2418.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2418.000f,false,nullptr }, 150, { 915.000f, 5597.000f }, { 150.000f,2418.000f });

	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,571.000f,75,false,nullptr }, 270, { 627.000f, 4861.000f }, { 571.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,571.000f,75,false,nullptr }, 270, { -748.000f, 4861.000f }, { 571.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,571.000f,75,false,nullptr }, 270, { -748.000f, 5241.000f }, { 571.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,571.000f,75,false,nullptr }, 270, { 702.000f, 5241.000f }, { 571.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,571.000f,75,false,nullptr }, 270, { -538.000f, 4846.000f }, { 571.000f,270.000f });
	...
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2235.000f,false,nullptr }, 150, { 2670.000f, -879.000f }, { 150.000f,2235.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2235.000f,false,nullptr }, 150, { 3235.000f, -879.000f }, { 150.000f,2235.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,2400.000f,75,false,nullptr }, 270, { 3900.000f, -2369.000f }, { 2400.000f,270.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,540.000f,false,nullptr }, 150, { 2670.000f, -2264.000f }, { 150.000f,540.000f });
	Enemies->AddEnemy(BUNBUN_ENEMY, { 3600.000f,-2184.000f }, 1);
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,180.000f,75,false,nullptr }, 270, { 2674.000f, 311.000f }, { 180.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,180.000f,75,false,nullptr }, 270, { 3239.000f, 311.000f }, { 180.000f,270.000f });
	LevelObjects->AddSpike({ 3724.000f,276.000f }, 10);
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,370.000f,75,false,nullptr }, 270, { 4229.000f, 446.000f }, { 370.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,64.000f,75,false,nullptr }, 270, { 3829.000f, 431.000f }, { 64.000f,270.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,1880.000f,false,nullptr }, 150, { 4449.000f, 1266.000f }, { 150.000f,1880.000f });
	//秘密1
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,2150.000f,75,false,nullptr }, 270, { -4911.000f, 4551.000f }, { 2150.000f,270.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,4475.000f,false,nullptr }, 150, { -6017.000f, 6641.000f }, { 150.000f,4475.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,4475.000f,false,nullptr }, 150, { -3902.000f, 6641.000f }, { 150.000f,4475.000f });
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,150.000f,false,nullptr },  150, { 2672.175f, -2521.343f }, { 150.000f,150.000f });
	...
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1052.000f,75,false,nullptr }, 270, { -4926.000f, 4776.000f }, { 1052.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1052.000f,75,false,nullptr }, 270, { -4951.000f, 5571.000f }, { 1052.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,347.000f,75,false,nullptr },  270, { -5876.000f, 4976.000f }, { 347.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,347.000f,75,false,nullptr },  270, { -4026.000f, 4976.000f }, { 347.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,347.000f,75,false,nullptr },  270, { -4306.000f, 5281.000f }, { 347.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,347.000f,75,false,nullptr },  270, { -5621.000f, 5281.000f }, { 347.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,249.000f,75,false,nullptr },  270, { -5502.306f, 5864.347f }, { 249.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,249.000f,75,false,nullptr },  270, { -4352.306f, 5864.347f }, { 249.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1037.000f,75,false,nullptr }, 270, { -4377.306f, 6164.347f }, { 1037.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1037.000f,75,false,nullptr }, 270, { -5552.306f, 6164.347f }, { 1037.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,165.000f,75,false,nullptr },  270, { -4961.974f, 6432.000f }, { 165.000f,270.000f });
	...
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1040.000f,75,false,nullptr }, 270, { 5363.529f, -1996.207f }, { 1040.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1040.000f,75,false,nullptr }, 270, { 6138.529f, -1646.207f }, { 1040.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1040.000f,75,false,nullptr }, 270, { 7013.529f, -1346.207f }, { 1040.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,3890.000f,75,false,nullptr }, 270, { 9263.529f, -1021.207f }, { 3890.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1040.000f,75,false,nullptr }, 270, { 5363.529f, -1996.207f }, { 1040.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1040.000f,75,false,nullptr }, 270, { 6138.529f, -1646.207f }, { 1040.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1040.000f,75,false,nullptr }, 270, { 7013.529f, -1346.207f }, { 1040.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,3890.000f,75,false,nullptr }, 270, { 9263.529f, -1021.207f }, { 3890.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,480.000f,75,false,nullptr },  270, { 10969.529f, -773.207f }, { 480.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,480.000f,75,false,nullptr },  270, { 10429.529f, -573.207f }, { 480.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,480.000f,75,false,nullptr },  270, { 10979.529f, -358.207f }, { 480.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,480.000f,75,false,nullptr },  270, { 10454.529f, -138.207f }, { 480.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,480.000f,75,false,nullptr },  270, { 10939.529f, 111.793f }, { 480.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,480.000f,75,false,nullptr },  270, { 10409.529f, 311.793f }, { 480.000f,270.000f });

	goLastFloorAdded = Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,6075.000f + 200,75,false,nullptr }, 270, { 13339.529f, 636.793f }, { 6075.000f + 200,270.000f });//敵と戦う床
	Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,2790.000f,false,nullptr }, 150, { 11259.529f, -808.207f }, { 150.000f,2790.000f });
	LastGOAdded = LevelObjects->AddSpike({ 10161.000f,-1192.946f }, 25);
	LastGOAdded->SetRotation({ 0, 0, 180 });
	goWallLimitLeft = Walls->AddWall(EVIL_BLOCK_TEXTURE, { 0,0,150,4347.000f,false,nullptr }, 150, { 10150.525f, 1492.000f }, { 150.000f,4347.000f });
	LastSwitchAdded = (SwitchGO*)LevelObjects->AddSwitchBulb({ 8335.92f, -718.44f }, SWITCH_L1_No12, true);
	LastSwitchAdded->SetSwitchAsScaleInverter();
	LastSwitchAdded = (SwitchGO*)LevelObjects->AddSwitchBulb({ 12548.00f, 2064.50f }, SWITCH_L1_No13, true);
	LastSwitchAdded->SetSwitchAsScaleInverter();
	LastSwitchAdded = (SwitchGO*)LevelObjects->AddSwitchBulb({ 15678.00f, 1679.50f }, SWITCH_L1_No14, true);
	LastSwitchAdded->SetSwitchAsScaleInverter();
	LastSwitchAdded = (SwitchGO*)LevelObjects->AddSwitchBulb({ 20954.90f, -431.27f }, SWITCH_L1_No14, true);
	LastSwitchAdded->SetSwitchAsScaleInverter();
	LastGOAdded = Walls->AddWall(EVIL_BLOCK3_TEXTURE, { 0,0,150,5865.000f,false,nullptr }, 150, { 9030.355f, 741.310f }, { 150.000f,5865.000f }, STATIC_ID, WALL_SCALE_POSITIVE);
	LevelObjects->AddSpike({ 14424.025f,2791.728f }, 40);
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,995.000f,75,false,nullptr }, 270, { 11500.000f, 971.000f }, { 995.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,995.000f,75,false,nullptr }, 270, { 11500.000f, 1271.000f }, { 995.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,995.000f,75,false,nullptr }, 270, { 11500.000f, 1571.000f }, { 995.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,275.000f,75,false,nullptr }, 270, { 12350.000f, 1796.000f }, { 275.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,275.000f,75,false,nullptr }, 270, { 10700.000f, 1846.000f }, { 275.000f,270.000f });
	goWallLimitRight = Walls->AddWall(EVIL_BLOCK3_TEXTURE, { 0,0,150,2270.000f,false,nullptr }, 150, { 12824.025f, 1606.728f }, { 150.000f,2270.000f }, STATIC_ID, WALL_SCALE_NEGATIVE);
	LastGOAdded = Walls->AddWall(EVIL_BLOCK3_TEXTURE, { 0,0,150,2270.000f,false,nullptr }, 150, { 16044.025f, 1606.728f }, { 150.000f,2270.000f }, STATIC_ID, WALL_SCALE_POSITIVE);
	//((Wall*)LastGOAdded)->SetWallDeactivateableWhenScaleIsNegative(true);
	...
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,885.000f,75,false,nullptr }, 270, { 13894.025f, 1046.728f }, { 885.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,885.000f,75,false,nullptr }, 270, { 14944.025f, 1471.728f }, { 885.000f,270.000f });

	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,885.000f,75,false,nullptr }, 270, { 13894.025f, 1046.728f }, { 885.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,885.000f,75,false,nullptr }, 270, { 14944.025f, 1471.728f }, { 885.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,885.000f,75,false,nullptr }, 270, { 17089.025f, 276.728f }, { 885.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,885.000f,75,false,nullptr }, 270, { 17989.025f, -223.272f }, { 885.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,885.000f,75,false,nullptr }, 270, { 18864.025f, -723.272f }, { 885.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,885.000f,75,false,nullptr }, 270, { 19939.025f, -723.272f }, { 885.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,1217.000f,75,false,nullptr }, 270, { 21180.000f, -724.000f }, { 1217.000f,270.000f });

	LastGOAdded = Walls->AddWall(EVIL_BLOCK3_TEXTURE, { 0,0,150,5465.000f,false,nullptr }, 150, { 21245.000f, 1391.000f }, { 150.000f,5465.000f }, STATIC_ID, WALL_SCALE_NEGATIVE);
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,725.000f,75,false,nullptr }, 270, { 22120.000f, -449.000f }, { 725.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,725.000f,75,false,nullptr }, 270, { 22695.000f, -149.000f }, { 725.000f,270.000f });

	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,2360.000f,75,false,nullptr }, 270, { 10152.000f, -2089.000f }, { 2360.000f,270.000f });
	LastGOAdded = LevelObjects->AddSpike({ 10157.000f,-2249.000f }, 28);
	LastGOAdded->SetRotation({ 0, 0, 180 });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,319.000f,75,false,nullptr }, 270, { 13151.750f, 975.000f }, { 319.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,319.000f,75,false,nullptr }, 270, { 14339.000f, 1260.000f }, { 319.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,125.000f,75,false,nullptr }, 270, { 17648.572f, 55.047f }, { 125.000f,270.000f });
	Floors->AddFloor(DOMINOS_FLOOR_BLACK_TEXTURE, { 0,-80,125.000f,75,false,nullptr }, 270, { 18543.572f, -459.953f }, { 125.000f,270.000f });
	//終わり
...
//*****************************************************************************
//DebugRoomObjects関数
//デバッグルーム/レベルエディターのオブジェクトを追加する
//引数：void
//戻：void
//*****************************************************************************
void SceneInGame::DebugRoomObjects()
{
	Enemy * pLastEnemyAdded = nullptr;
	SetBackgroundColor(ColorBackground);
...
//戻：void
//*****************************************************************************
void SceneInGame::SetSubLevel(int SubLevel)
{
	if (Enemies)
		Enemies->ResetList();
	EndEnemyTextures();
...
//戻：void
//*****************************************************************************
void SceneInGame::AddToScore(int nToAdd)
{
	nScore += nToAdd;
}

//*****************************************************************************
//AddToScoreWithMultiplier関数
//ランクでスコアを増やす
//引数：int
//戻：void
//*****************************************************************************
void SceneInGame::AddToScoreWithMultiplier(int nToAdd)
{
...
//戻：void
//*****************************************************************************
void SceneInGame::AddGem(int newGemNum)
{
	nGems += newGemNum;
}
...
//戻：void
//*****************************************************************************
void SceneInGame::AddMaxGemNum(int newGemNum)
{
	nMaxGems += newGemNum;
}
...
//戻：void
//*****************************************************************************
void SceneInGame::SetLevelScale(float newScale)
{
...
//戻：float
//*****************************************************************************
float SceneInGame::GetLevelScale()
{
	return fLevelScale;
}
...
//戻：Go_List*
//*****************************************************************************
Go_List* SceneInGame::GetLevelObjects()
{
	return LevelObjects;
}
...
//戻：Go_List*
//*****************************************************************************
Go_List * SceneInGame::GetPickableGems()
{
	return PickableGems;
}
...
//戻：Enemy_List*
//*****************************************************************************
Enemy_List * SceneInGame::GetEnemies()
{
	return Enemies;
}
...
//戻：UIManager*
//*****************************************************************************
UIManager * SceneInGame::GetUIManager()
{
	return pUIManager;
}

//*****************************************************************************
//GetCurrentBackgroundColor関数
//バックグラウンドの色を戻す
//引数：void
//戻：Color
//*****************************************************************************
Color SceneInGame::GetCurrentBackgroundColor()
{
...
//戻：void
//*****************************************************************************
void SceneInGame::SetLevel(int newLevel)
{
...
//戻：int
//*****************************************************************************
int SceneInGame::GetCurrentLevel()
{
	return nCurrentLevel;
}

//*****************************************************************************
//GetCurrentSubLevel関数
//現在のサブレベルを戻す
//引数：void
//戻：int
//*****************************************************************************
int SceneInGame::GetCurrentSubLevel()
{
